...
def update():
    ...
    if new == old:
        updater.info("Linux.Unify Updater", "System already version 22.10.1. Skipped Update.")
    else:
        updater.info("Linux.Unify Updater", "System updated to 22.10.1. Update Complete.")
